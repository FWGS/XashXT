...
#define pglMultiTexCoord1fARB glMultiTexCoord1fARB
#define pglMultiTexCoord2fARB glMultiTexCoord2fARB
#define pglMultiTexCoord3fARB glMultiTexCoord3fARB
#define pglMultiTexCoord4fARB glMultiTexCoord4fARB
...
#define pglTexImage3DEXT glTexImage3DEXT
#define pglTexSubImage3DEXT glTexSubImage3DEXT
#define pglCopyTexSubImage3DEXT glCopyTexSubImage3DEXT
#define pglStencilOpSeparateATI glStencilOpSeparateATI
#define pglStencilFuncSeparateATI glStencilFuncSeparateATI
...
#define pglGetProgramivARB glGetProgramivARB
...
#define pglGetCompressedTexImageARB glGetCompressedTexImageARB
...
void pglCopyTexSubImage2D (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint x, GLint y, GLsizei width, GLsizei height);

void pglTexEnvi(GLenum target, GLenum pname, GLint param);

void pglBindFramebuffer(GLenum target, GLuint framebuffer);
void pglDeleteFramebuffers(GLsizei n, const GLuint *framebuffers);
void pglGenFramebuffers (GLsizei n, GLuint *framebuffers);
GLenum pglCheckFramebufferStatus(GLenum target);

GLboolean pglIsRenderbuffer (GLuint renderbuffer);
void pglBindRenderbuffer (GLenum target, GLuint renderbuffer);
void pglDeleteRenderbuffers (GLsizei n, const GLuint *renderbuffers);
void pglGenRenderbuffers (GLsizei n, GLuint *renderbuffers);


void pglRenderbufferStorage(GLenum target, GLenum internalformat, GLsizei width, GLsizei height);
#define pglBindProgramARB(a,b)

void pglFramebufferTexture2D(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level);

void pglFramebufferRenderbuffer (GLenum target, GLenum attachment, GLenum renderbuffertarget, GLuint renderbuffer);
#define pglDrawRangeElementsEXT(a,b,c,d,e,f)

void pglNormalPointer(GLenum type, GLsizei stride, const void *ptr);
